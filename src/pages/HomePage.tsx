            ...
            <div className={`min-h-[calc(100vh-4rem)] flex items-center relative`}>
                <div
                    className={`container mx-auto transition-all duration-300 ease-out
                        ${isMediumScreen && isFixed ? 'fixed top-[12rem] left-[12rem]' : ''}
                ...
                >
                    <div className="flex flex-col items-center md:items-start">
                        <h1
                            className="font-bold text-center md:text-left mb-4 bg-gradient-to-r from-primary to-cyan-500 bg-clip-text text-transparent transition-all"
                            style={{
                        ...
                        <p
                            className="text-center md:text-left text-muted-foreground mb-6 transition-all"
                            style={{
